...
class _ApiClient implements ApiClient {
  _ApiClient(
    ...
    baseUrl ??= 'https://10.10.10.86:443/Irregation/api/SensorData';
  }
  ...
  Future<List<SensorResponse>> getSensors(userId) async {
    ...
    final _result = await _dio
        .fetch<List<dynamic>>(_setStreamType<List<SensorResponse>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    var value = _result.data!
        .map((dynamic i) => SensorResponse.fromJson(i as Map<String, dynamic>))
        .toList();
    return value;
  }
  ...
  @override
  Future<int> addSensor(sensor) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(sensor.toJson());
  ...
  Future<List<IrregationScheduleResponse>> getSchedules(
    ...
    final _result = await _dio.fetch<List<dynamic>>(
        _setStreamType<List<IrregationScheduleResponse>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    var value = _result.data!
        .map((dynamic i) =>
            IrregationScheduleResponse.fromJson(i as Map<String, dynamic>))
        .toList();
    return value;
  }
  ...
  @override
  Future<void> openValve(uuid) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
  ...
  @override
  Future<void> closeValve(uuid) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
